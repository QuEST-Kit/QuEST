...
\item 
void \hyperlink{qubits_8c_a70b6649dc52a36ff2d0ed91fb443c3c4}{rotate\+Qubit\+By\+Angle} (\hyperlink{structMultiQubit}{Multi\+Qubit} multi\+Qubit, const int rot\+Qubit, \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{R\+E\+AL} angle, \hyperlink{structVector}{Vector} unit\+Axis)
...
\mbox{\Hypertarget{qubits_8c_a793584932ae384c82e7e42db7d35d18d}\label{qubits_8c_a793584932ae384c82e7e42db7d35d18d}} 
...
{\footnotesize\ttfamily int compare\+States (\begin{DoxyParamCaption}\item[{\hyperlink{structMultiQubit}{Multi\+Qubit}}]{mq1,  }\item[{\hyperlink{structMultiQubit}{Multi\+Qubit}}]{mq2,  }\item[{\hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{R\+E\+AL}}]{precision }\end{DoxyParamCaption})}
...
\begin{DoxyCode}
357                                                                  \{
358         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} diff;
359         \textcolor{keywordtype}{int} chunkSize = mq1.\hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps};
360         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<chunkSize; i++)\{
361                 diff = mq1.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a4195cac6c784ea1b6271f1c7dba1548a}{real}[i] - mq2.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.
      \hyperlink{structComplexArray_a4195cac6c784ea1b6271f1c7dba1548a}{real}[i];
362                 \textcolor{keywordflow}{if} (diff<0) diff *= -1;
363                 \textcolor{keywordflow}{if} (diff>precision) \textcolor{keywordflow}{return} 0;
364                 diff = mq1.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a79dde47c7ae530c79cebfdf57b225968}{imag}[i] - mq2.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.
      \hyperlink{structComplexArray_a79dde47c7ae530c79cebfdf57b225968}{imag}[i];
365                 \textcolor{keywordflow}{if} (diff<0) diff *= -1;
366                 \textcolor{keywordflow}{if} (diff>precision) \textcolor{keywordflow}{return} 0;
367         \}
...
605 \} 
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_a9c02591bc64c2918503afa231d90d83f}\label{qubits_8c_a9c02591bc64c2918503afa231d90d83f}} 
...
57 \}
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_ae5d6acc322314d7a3d8a2eccf00d3b19}\label{qubits_8c_ae5d6acc322314d7a3d8a2eccf00d3b19}} 
...
Referenced by control\+Not\+Distributed(), control\+Not\+Local(), control\+Phase\+Gate(), control\+Rotate\+Qubit\+Distributed(), control\+Rotate\+Qubit\+Local(), filter\+Out111\+Local(), init\+State\+Of\+Single\+Qubit(), prob\+Of\+Filter\+Out111\+Local(), and quad\+C\+Phase\+Gate().


\begin{DoxyCode}
1451 \{
1452         \textcolor{keywordflow}{return} (theEncodedNumber & ( 1LL << locationOfBitFromRight )) >> locationOfBitFromRight;
1453 \}
\end{DoxyCode}
...
1379 \}
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_a8f10aabf9f607f19093aee54630caa21}\label{qubits_8c_a8f10aabf9f607f19093aee54630caa21}} 
...
1074 \}
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_a433876ee9f3bcc54af346300f571fc3c}\label{qubits_8c_a433876ee9f3bcc54af346300f571fc3c}} 
...
{\footnotesize\ttfamily void initialize\+State\+From\+Single\+File (\begin{DoxyParamCaption}\item[{\hyperlink{structMultiQubit}{Multi\+Qubit} $\ast$}]{multi\+Qubit,  }\item[{char}]{filename\mbox{[}200\mbox{]},  }\item[{\hyperlink{structQuESTEnv}{Qu\+E\+S\+T\+Env}}]{env }\end{DoxyParamCaption})}
...
\begin{DoxyCode}
322                                                                                             \{
323         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} chunkSize, stateVecSize;
324         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} indexInChunk, totalIndex;
325 
326         chunkSize = multiQubit->\hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps};
327         stateVecSize = chunkSize*multiQubit->\hyperlink{structMultiQubit_acd43f2f57991709c9e94f73662c972b2}{numChunks};
328 
329         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} *stateVecReal = multiQubit->\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a4195cac6c784ea1b6271f1c7dba1548a}{real};
330         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} *stateVecImag = multiQubit->\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a79dde47c7ae530c79cebfdf57b225968}{imag};
331         
332         FILE *fp;
333         \textcolor{keywordtype}{char} line[200];
334 
335         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} rank=0; rank<(multiQubit->\hyperlink{structMultiQubit_acd43f2f57991709c9e94f73662c972b2}{numChunks}); rank++)\{
336                 \textcolor{keywordflow}{if} (rank==multiQubit->\hyperlink{structMultiQubit_ab10c88249fa3825d6227ceec01d37e37}{chunkId})\{
337                         fp = fopen(filename, \textcolor{stringliteral}{"r"});
338                         indexInChunk = 0; totalIndex = 0;
339                         \textcolor{keywordflow}{while} (fgets(line, \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char})*200, fp) != NULL && totalIndex<stateVecSize)\{
340                                 \textcolor{keywordflow}{if} (line[0]!=\textcolor{charliteral}{'#'})\{
341                                         \textcolor{keywordtype}{int} chunkId = totalIndex/chunkSize;
342                                         \textcolor{keywordflow}{if} (chunkId==multiQubit->\hyperlink{structMultiQubit_ab10c88249fa3825d6227ceec01d37e37}{chunkId})\{
344                                                 sscanf(line, \textcolor{stringliteral}{"%lf, %lf"}, &(stateVecReal[indexInChunk]), 
345                                                                 &(stateVecImag[indexInChunk]));
346                                                 indexInChunk += 1;
347                                         \}
348                                         totalIndex += 1;
349                                 \}
...
351                         fclose(fp);
352                 \}
353                 \hyperlink{qubits_8h_a8d31fe2d1ad4d01e2a1f5f6b8bc15b77}{syncQuESTEnv}(env);
354         \}
355 \}
\end{DoxyCode}
...
\begin{DoxyCode}
291 \{
292         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} chunkSize;
293         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} index;
294 
295         \textcolor{comment}{// dimension of the state vector}
296         chunkSize = multiQubit->\hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps};
297 
298         \textcolor{comment}{// Can't use multiQubit->stateVec as a private OMP var}
299         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} *stateVecReal = multiQubit->\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a4195cac6c784ea1b6271f1c7dba1548a}{real};
300         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} *stateVecImag = multiQubit->\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a79dde47c7ae530c79cebfdf57b225968}{imag};
301 
302         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} chunkOffset = (2.0*chunkSize*multiQubit->\hyperlink{structMultiQubit_ab10c88249fa3825d6227ceec01d37e37}{chunkId})/10.0;
303 
304         \textcolor{comment}{// initialise the state to |0000..0000>}
305 \textcolor{preprocessor}{# ifdef \_OPENMP}
306 \textcolor{preprocessor}{# pragma omp parallel \(\backslash\)}
307 \textcolor{preprocessor}{        default  (none) \(\backslash\)}
308 \textcolor{preprocessor}{        shared   (chunkSize, stateVecReal, stateVecImag, chunkOffset) \(\backslash\)}
309 \textcolor{preprocessor}{        private  (index) }
...
315                 \textcolor{keywordflow}{for} (index=0; index<chunkSize; index++) \{
...
320 \}
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_a7169fd0442cbc3418f3fac4d13363ca2}\label{qubits_8c_a7169fd0442cbc3418f3fac4d13363ca2}} 
...
{\footnotesize\ttfamily void init\+State\+Of\+Single\+Qubit (\begin{DoxyParamCaption}\item[{\hyperlink{structMultiQubit}{Multi\+Qubit} $\ast$}]{multi\+Qubit,  }\item[{int}]{qubit\+Id,  }\item[{int}]{outcome }\end{DoxyParamCaption})}
...
\begin{DoxyCode}
244 \{
245         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} chunkSize, stateVecSize;
246         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} index;
247         \textcolor{keywordtype}{int} bit;
248         \textcolor{keyword}{const} \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} chunkId=multiQubit->\hyperlink{structMultiQubit_ab10c88249fa3825d6227ceec01d37e37}{chunkId};
249 
250         \textcolor{comment}{// dimension of the state vector}
251         chunkSize = multiQubit->\hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps};
252         stateVecSize = chunkSize*multiQubit->\hyperlink{structMultiQubit_acd43f2f57991709c9e94f73662c972b2}{numChunks};
253         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} normFactor = 1.0/sqrt(stateVecSize/2);
254 
255         \textcolor{comment}{// Can't use multiQubit->stateVec as a private OMP var}
256         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} *stateVecReal = multiQubit->\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a4195cac6c784ea1b6271f1c7dba1548a}{real};
257         \hyperlink{precision_8h_a4b654506f18b8bfd61ad2a29a7e38c25}{REAL} *stateVecImag = multiQubit->\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a79dde47c7ae530c79cebfdf57b225968}{imag};
258 
259         \textcolor{comment}{// initialise the state to |0000..0000>}
260 \textcolor{preprocessor}{# ifdef \_OPENMP}
261 \textcolor{preprocessor}{# pragma omp parallel \(\backslash\)}
262 \textcolor{preprocessor}{        default  (none) \(\backslash\)}
263 \textcolor{preprocessor}{        shared   (chunkSize, stateVecReal, stateVecImag, normFactor, qubitId, outcome) \(\backslash\)}
264 \textcolor{preprocessor}{        private  (index, bit) }
265 \textcolor{preprocessor}{# endif}
266         \{
267 \textcolor{preprocessor}{# ifdef \_OPENMP}
268 \textcolor{preprocessor}{                # pragma omp for schedule (static)}
269 \textcolor{preprocessor}{# endif}
270                 \textcolor{keywordflow}{for} (index=0; index<chunkSize; index++) \{
271                         bit = \hyperlink{qubits_8c_a100463f6ec212c76a5fad99579000505}{extractBit}(qubitId, index+chunkId*chunkSize);
272                         \textcolor{keywordflow}{if} (bit==outcome) \{
...
279                 \}
280         \}
281         \textcolor{keywordflow}{if} (\hyperlink{qubits_8c_ad72dbcf6d0153db1b8d8a58001feed83}{DEBUG}) printf(\textcolor{stringliteral}{"COMPLETED INIT\(\backslash\)n"});
282 \}
\end{DoxyCode}
...
105 \}
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_a842d6884e063a5865a2232cba56b65ac}\label{qubits_8c_a842d6884e063a5865a2232cba56b65ac}} 
...
133 \}
\end{DoxyCode}
\mbox{\Hypertarget{qubits_8c_a70b6649dc52a36ff2d0ed91fb443c3c4}\label{qubits_8c_a70b6649dc52a36ff2d0ed91fb443c3c4}} 
\index{qubits.\+c@{qubits.\+c}!rotate\+Qubit\+By\+Angle@{rotate\+Qubit\+By\+Angle}}
\index{rotate\+Qubit\+By\+Angle@{rotate\+Qubit\+By\+Angle}!qubits.\+c@{qubits.\+c}}
