...
Definition at line 67 of file qubits\+\_\+env\+\_\+mpi.\+c.
...
\begin{DoxyCode}
67                                                   \{
68         \textcolor{keywordtype}{double} pTotal=0; 
69         \textcolor{keywordtype}{double} allRankTotals=0;
70         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} index;
71         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} numAmpsPerRank = multiQubit.\hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps};
72         \textcolor{keywordflow}{for} (index=0; index<numAmpsPerRank; index++)\{ 
73                 pTotal+=multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a1cf9fd31d6dce5ef618d2bcf3e4f8b69}{real}[index]*multiQubit.
...
74                 pTotal+=multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_aa409fd14e1ff3e1fdcc53cc4eb77a7a8}{imag}[index]*multiQubit.
...
75         \} 
76         \textcolor{keywordflow}{if} (\hyperlink{qubits__env__mpi_8c_ad72dbcf6d0153db1b8d8a58001feed83}{DEBUG}) printf(\textcolor{stringliteral}{"before calc prob. %d\(\backslash\)n"}, multiQubit.\hyperlink{structMultiQubit_acd43f2f57991709c9e94f73662c972b2}{numChunks});
77         \textcolor{keywordflow}{if} (multiQubit.\hyperlink{structMultiQubit_acd43f2f57991709c9e94f73662c972b2}{numChunks}>1) MPI\_Reduce(&pTotal, &allRankTotals, 1, MPI\_DOUBLE, MPI\_SUM, 0,
       MPI\_COMM\_WORLD);
78         \textcolor{keywordflow}{else} allRankTotals=pTotal;
79 
80         \textcolor{keywordflow}{return} allRankTotals;
81 \}
\end{DoxyCode}
...
Definition at line 92 of file qubits\+\_\+env\+\_\+mpi.\+c.
...
\begin{DoxyCode}
93 \{       
94         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} sizeHalfBlock = 1LL << (rotQubit);
95         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} sizeBlock = sizeHalfBlock*2;
96         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} posInBlock = (chunkId*chunkSize) % sizeBlock;
97         \textcolor{keywordflow}{return} posInBlock<sizeHalfBlock;
98 \}
\end{DoxyCode}
...
\begin{DoxyCode}
213 \{
214         \textcolor{keywordtype}{double} stateProb=0, totalStateProb=0;
215         \textcolor{keywordtype}{int} skipValuesWithinRank = \hyperlink{qubits__env__mpi_8c_acb89022e532cdb58441d5e2254a08dfb}{halfMatrixBlockFitsInChunk}(multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, measureQubit);
216         \textcolor{keywordflow}{if} (skipValuesWithinRank) \{
217                 stateProb = \hyperlink{qubits_8c_a1c0a25823add0bd9f925a9164dc21870}{findProbabilityOfZeroLocal}(multiQubit, measureQubit);
218         \} \textcolor{keywordflow}{else} \{
219                 \textcolor{keywordflow}{if} (!\hyperlink{qubits__env__mpi_8c_a7cad4a087e3fc919efeb9d22ec451481}{isChunkToSkipInFindPZero}(multiQubit.
...
220                         stateProb = \hyperlink{qubits_8c_a2d302738d123129a388edf81b845fd89}{findProbabilityOfZeroDistributed}(
      multiQubit, measureQubit);
221                 \} \textcolor{keywordflow}{else} stateProb = 0;
222         \}
223         MPI\_Reduce(&stateProb, &totalStateProb, 1, MPI\_DOUBLE, MPI\_SUM, 0, MPI\_COMM\_WORLD);
224         \textcolor{keywordflow}{return} totalStateProb;
225 \}
\end{DoxyCode}
...
Definition at line 134 of file qubits\+\_\+env\+\_\+mpi.\+c.
...
\begin{DoxyCode}
135 \{
136         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} sizeHalfBlock = 1LL << (rotQubit);
137         \textcolor{keywordtype}{int} chunksPerHalfBlock = sizeHalfBlock/chunkSize;
138         \textcolor{keywordflow}{if} (\hyperlink{qubits__env__mpi_8c_ac6f2d948c6afc21ecd934a9794f27271}{chunkIsUpper})\{
139                 \textcolor{keywordflow}{return} chunkId + chunksPerHalfBlock;
140         \} \textcolor{keywordflow}{else} \{
141                 \textcolor{keywordflow}{return} chunkId - chunksPerHalfBlock;
142         \}
143 \}
\end{DoxyCode}
...
\begin{DoxyCode}
114 \{
115         \textcolor{keywordflow}{if} (\hyperlink{qubits__env__mpi_8c_ac6f2d948c6afc21ecd934a9794f27271}{chunkIsUpper})\{
116                 *rot1=alpha;
117                 rot2->\hyperlink{structComplex_a0138f5fe2b2c6180b8fcda77a7aa51c5}{real}=-beta.\hyperlink{structComplex_a0138f5fe2b2c6180b8fcda77a7aa51c5}{real};
118                 rot2->\hyperlink{structComplex_a2bb90cc563599c3c8bdec9acf9ea40a6}{imag}=-beta.\hyperlink{structComplex_a2bb90cc563599c3c8bdec9acf9ea40a6}{imag};
...
Definition at line 153 of file qubits\+\_\+env\+\_\+mpi.\+c.
...
\begin{DoxyCode}
154 \{
155         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} sizeHalfBlock = 1LL << (rotQubit);
156         \textcolor{keywordflow}{if} (chunkSize > sizeHalfBlock) \textcolor{keywordflow}{return} 1;
157         \textcolor{keywordflow}{else} \textcolor{keywordflow}{return} 0;
158 \}
\end{DoxyCode}
...
Definition at line 59 of file qubits\+\_\+env\+\_\+mpi.\+c.
...
\begin{DoxyCode}
59                                                                                  \{
60         \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \textcolor{keywordtype}{int} sizeHalfBlock = 1LL << (measureQubit);
61         \textcolor{keywordtype}{int} numChunksToSkip = sizeHalfBlock/chunkSize;
62         \textcolor{comment}{// calculate probability by summing over numChunksToSkip, then skipping numChunksToSkip, etc}
63         \textcolor{keywordtype}{int} bitToCheck = chunkId & numChunksToSkip;
64         \textcolor{keywordflow}{return} bitToCheck;
65 \}
\end{DoxyCode}
...
\begin{DoxyCode}
162 \{
163         \textcolor{comment}{// flag to require memory exchange. 1: an entire block fits on one rank, 0: at most half a block
       fits on one rank}
164         \textcolor{keywordtype}{int} useLocalDataOnly = \hyperlink{qubits__env__mpi_8c_acb89022e532cdb58441d5e2254a08dfb}{halfMatrixBlockFitsInChunk}(multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, rotQubit);
165         \hyperlink{structComplex}{Complex} rot1, rot2;
166 
167         \textcolor{comment}{// rank's chunk is in upper half of block }
168         \textcolor{keywordtype}{int} rankIsUpper;
169         \textcolor{keywordtype}{int} pairRank; \textcolor{comment}{// rank of corresponding chunk}
170 
171         \textcolor{comment}{// MPI send/receive vars}
172         \textcolor{keywordtype}{int} TAG=100;
173         MPI\_Status status;
174 
175         \textcolor{keywordtype}{double} *stateVecReal, stateVecImag, stateVecRealPair, stateVecImagPair;
176         
177 
178         \textcolor{keywordflow}{if} (useLocalDataOnly)\{
179                 \textcolor{comment}{// all values required to update state vector lie in this rank}
180                 \hyperlink{qubits_8c_acb059cbcb8c7910a5fc43d21da4f5dea}{rotateQubitLocal}(multiQubit, rotQubit, alpha, beta);
181         \} \textcolor{keywordflow}{else} \{
182                 \textcolor{comment}{// need to get corresponding chunk of state vector from other rank}
183                 rankIsUpper = \hyperlink{qubits__env__mpi_8c_ac6f2d948c6afc21ecd934a9794f27271}{chunkIsUpper}(multiQubit.\hyperlink{structMultiQubit_ab10c88249fa3825d6227ceec01d37e37}{chunkId}, multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, rotQubit);
184                 \hyperlink{qubits__env__mpi_8c_adb4b0373425b282abed27742d0ce0872}{getRotAngle}(rankIsUpper, &rot1, &rot2, alpha, beta);
185                 pairRank = \hyperlink{qubits__env__mpi_8c_af639d6bba9782cb708fb7f9bc406f28b}{getChunkPairId}(rankIsUpper, multiQubit.
...
186                 \textcolor{comment}{//printf("%d rank has pair rank: %d\(\backslash\)n", multiQubit.rank, pairRank);}
187                 \textcolor{comment}{// get corresponding values from my pair}
188                 MPI\_Sendrecv(multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_a1cf9fd31d6dce5ef618d2bcf3e4f8b69}{real}, multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, MPI\_DOUBLE, pairRank, TAG,
189                                  multiQubit.\hyperlink{structMultiQubit_a76f7db4eab52d2b30f58f973ada809c5}{pairStateVec}.\hyperlink{structComplexArray_a1cf9fd31d6dce5ef618d2bcf3e4f8b69}{real}, multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, MPI\_DOUBLE, pairRank, TAG,
190                                  MPI\_COMM\_WORLD, &status);
191                 \textcolor{comment}{//printf("rank: %d err: %d\(\backslash\)n", multiQubit.rank, err);}
192                 MPI\_Sendrecv(multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}.\hyperlink{structComplexArray_aa409fd14e1ff3e1fdcc53cc4eb77a7a8}{imag}, multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, MPI\_DOUBLE, pairRank, TAG,
193                                 multiQubit.\hyperlink{structMultiQubit_a76f7db4eab52d2b30f58f973ada809c5}{pairStateVec}.\hyperlink{structComplexArray_aa409fd14e1ff3e1fdcc53cc4eb77a7a8}{imag}, multiQubit.
      \hyperlink{structMultiQubit_ae16f47d8b725c914fb7f66b6498d79db}{numAmps}, MPI\_DOUBLE, pairRank, TAG,
194                                 MPI\_COMM\_WORLD, &status);
195                 \textcolor{comment}{// this rank's values are either in the upper of lower half of the block. send values to
       rotateQubitDistributed}
196                 \textcolor{comment}{// in the correct order}
197                 \textcolor{keywordflow}{if} (rankIsUpper)\{
198                         \hyperlink{qubits_8c_a6ff67d25363f39fd57a4e76621a4bfd5}{rotateQubitDistributed}(multiQubit,rotQubit,rot1,rot2,
199                                 multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}, \textcolor{comment}{//upper}
200                                 multiQubit.\hyperlink{structMultiQubit_a76f7db4eab52d2b30f58f973ada809c5}{pairStateVec}, \textcolor{comment}{//lower}
201                                 multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}); \textcolor{comment}{//output}
202                 \} \textcolor{keywordflow}{else} \{
203                         \hyperlink{qubits_8c_a6ff67d25363f39fd57a4e76621a4bfd5}{rotateQubitDistributed}(multiQubit,rotQubit,rot1,rot2,
204                                 multiQubit.\hyperlink{structMultiQubit_a76f7db4eab52d2b30f58f973ada809c5}{pairStateVec}, \textcolor{comment}{//upper}
205                                 multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}, \textcolor{comment}{//lower}
206                                 multiQubit.\hyperlink{structMultiQubit_a45483190d6b01ef6b2f98f2bec9ab94f}{stateVec}); \textcolor{comment}{//output}
207                 \}
208         \}
209 \}
\end{DoxyCode}
