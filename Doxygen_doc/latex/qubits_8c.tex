...
\item 
void \hyperlink{qubits_8c_a70b6649dc52a36ff2d0ed91fb443c3c4}{rotateQubitByAngle} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int rotQubit, REAL angle, Vector unitAxis)
...
void \hyperlink{qubits_8c_a824d71bae93236d8a3cd43589044eaee}{controlRotateQubitLocal} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int rotQubit, const int controlQubit, \hyperlink{structComplex}{Complex} alpha, \hyperlink{structComplex}{Complex} beta)
...
\begin{DoxyCompactList}\small\item\em Rotate a single qubit by \{\{0,1\},\{1,0\}. \item\end{DoxyCompactList}\item 
void \hyperlink{qubits_8c_a2901e2e5531cb77f87ea54b3fc28f51a}{controlNotLocal} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int targetQubit, const int controlQubit)
...
void \hyperlink{qubits_8c_a774dd1217fcc3591a74a74d5667afa29}{controlNotDistributed} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int targetQubit, const int controlQubit, \hyperlink{structComplexArray}{ComplexArray} stateVecIn, \hyperlink{structComplexArray}{ComplexArray} stateVecOut)
\begin{DoxyCompactList}\small\item\em Rotate a single qubit by \{\{0,1\},\{1,0\}. \item\end{DoxyCompactList}\item 
...
void \hyperlink{qubits_8c_a0ad4584e44f567c140b653ed36d26ccf}{controlPhaseGate} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int idQubit1, const int idQubit2)
\begin{DoxyCompactList}\small\item\em The control phase (the two qubit phase gate). \item\end{DoxyCompactList}\item 
void \hyperlink{qubits_8c_aca7765bd500718f98700a172351748cc}{quadCPhaseGate} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int idQubit1, const int idQubit2, const int idQubit3, const int idQubit4)
\begin{DoxyCompactList}\small\item\em The control not gate. \item\end{DoxyCompactList}\item 
void \hyperlink{qubits_8c_a53614ce19e0a4f2c41b400cf05dc5bd1}{measureInStateLocal} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, int measureQubit, REAL totalProbability, int outcome)
...
REAL \hyperlink{qubits_8c_a35e5ac30c8427c482a97b33a4e295535}{measureInStateDistributedRenorm} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int measureQubit, const REAL totalProbability)
...
void \hyperlink{qubits_8c_ac39efc9ed939382276ebd0c15dd6a0fa}{measureInStateDistributedSetZero} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int measureQubit)
\begin{DoxyCompactList}\small\item\em Set all amplitudes in one chunk to 0. \item\end{DoxyCompactList}\item 
void \hyperlink{qubits_8c_a2d73fd11c1d154640dbf114da8f34c64}{filterOut111Local} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int idQubit1, const int idQubit2, const int idQubit3, const REAL probOfFilter)
...
REAL \hyperlink{qubits_8c_a096cddbac961f0651a084d2ceb905d1b}{probOfFilterOut111Local} (\hyperlink{structMultiQubit}{MultiQubit} multiQubit, const int idQubit1, const int idQubit2, const int idQubit3)
...
Definition at line 357 of file qubits.c.

References ComplexArray::imag, MultiQubit::numAmps, ComplexArray::real, REAL, and MultiQubit::stateVec.

Referenced by test\_\-controlNot(), test\_\-controlPhaseGate(), test\_\-controlRotateQubit(), test\_\-filterOut111(), test\_\-hadamard(), test\_\-initStatePlus(), test\_\-initStateZero(), test\_\-measureInState(), test\_\-quadCPhaseGate(), test\_\-rotateQubit(), test\_\-sGate(), test\_\-sigmaX(), test\_\-sigmaY(), test\_\-sigmaZ(), and test\_\-tGate().


\begin{DoxyCode}
357                                                                  {
358         REAL diff;
359         int chunkSize = mq1.numAmps;
360         for (int i=0; i<chunkSize; i++){
361                 diff = mq1.stateVec.real[i] - mq2.stateVec.real[i];
362                 if (diff<0) diff *= -1;
363                 if (diff>precision) return 0;
364                 diff = mq1.stateVec.imag[i] - mq2.stateVec.imag[i];
365                 if (diff<0) diff *= -1;
366                 if (diff>precision) return 0;
367         }
368         return 1;
369 }
\end{DoxyCode}
\hypertarget{qubits_8c_a774dd1217fcc3591a74a74d5667afa29}{
\index{qubits.c@{qubits.c}!controlNotDistributed@{controlNotDistributed}}
\index{controlNotDistributed@{controlNotDistributed}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a774dd1217fcc3591a74a74d5667afa29}
...
906 } 
\end{DoxyCode}
\hypertarget{qubits_8c_a2901e2e5531cb77f87ea54b3fc28f51a}{
\index{qubits.c@{qubits.c}!controlNotLocal@{controlNotLocal}}
\index{controlNotLocal@{controlNotLocal}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a2901e2e5531cb77f87ea54b3fc28f51a}
...
851 }
\end{DoxyCode}
\hypertarget{qubits_8c_a0ad4584e44f567c140b653ed36d26ccf}{
...
\label{qubits_8c_a0ad4584e44f567c140b653ed36d26ccf}
...
Referenced by test\_\-controlPhaseGate().
...
1500 }
\end{DoxyCode}
\hypertarget{qubits_8c_ab22d031e2507f1d859292103a99e2378}{
\index{qubits.c@{qubits.c}!controlRotateQubitDistributed@{controlRotateQubitDistributed}}
\index{controlRotateQubitDistributed@{controlRotateQubitDistributed}!qubits.c@{qubits.c}}
...
\label{qubits_8c_ab22d031e2507f1d859292103a99e2378}
...
679 }
\end{DoxyCode}
\hypertarget{qubits_8c_a824d71bae93236d8a3cd43589044eaee}{
\index{qubits.c@{qubits.c}!controlRotateQubitLocal@{controlRotateQubitLocal}}
\index{controlRotateQubitLocal@{controlRotateQubitLocal}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a824d71bae93236d8a3cd43589044eaee}
...
Referenced by test\_\-controlNot(), test\_\-controlPhaseGate(), test\_\-controlRotateQubit(), test\_\-filterOut111(), test\_\-findProbabilityOfOutcome(), test\_\-hadamard(), test\_\-initStatePlus(), test\_\-initStateZero(), test\_\-measureInState(), test\_\-probOfFilterOut111(), test\_\-quadCPhaseGate(), test\_\-rotateQubit(), test\_\-sGate(), test\_\-sigmaX(), test\_\-sigmaY(), test\_\-sigmaZ(), and test\_\-tGate().
...
Definition at line 1450 of file qubits.c.

Referenced by controlNotDistributed(), controlNotLocal(), controlPhaseGate(), controlRotateQubitDistributed(), controlRotateQubitLocal(), filterOut111Local(), initStateOfSingleQubit(), probOfFilterOut111Local(), and quadCPhaseGate().


\begin{DoxyCode}
1451 {
1452         return (theEncodedNumber & ( 1LL << locationOfBitFromRight )) >> location
      OfBitFromRight;
1453 }
\end{DoxyCode}
\hypertarget{qubits_8c_a2d73fd11c1d154640dbf114da8f34c64}{
\index{qubits.c@{qubits.c}!filterOut111Local@{filterOut111Local}}
\index{filterOut111Local@{filterOut111Local}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a2d73fd11c1d154640dbf114da8f34c64}
...
Definition at line 322 of file qubits.c.
...
Referenced by test\_\-controlNot(), test\_\-controlPhaseGate(), test\_\-controlRotateQubit(), test\_\-filterOut111(), test\_\-hadamard(), test\_\-initStatePlus(), test\_\-initStateZero(), test\_\-probOfFilterOut111(), test\_\-quadCPhaseGate(), test\_\-sGate(), test\_\-sigmaX(), test\_\-sigmaY(), test\_\-sigmaZ(), and test\_\-tGate().


\begin{DoxyCode}
322                                                                                  
                 {
323         long long int chunkSize, stateVecSize;
324         long long int indexInChunk, totalIndex;
325 
326         chunkSize = multiQubit->numAmps;
327         stateVecSize = chunkSize*multiQubit->numChunks;
328 
329         REAL *stateVecReal = multiQubit->stateVec.real;
330         REAL *stateVecImag = multiQubit->stateVec.imag;
331         
332         FILE *fp;
333         char line[200];
334 
335         for (int rank=0; rank<(multiQubit->numChunks); rank++){
336                 if (rank==multiQubit->chunkId){
337                         fp = fopen(filename, "r");
338                         indexInChunk = 0; totalIndex = 0;
339                         while (fgets(line, sizeof(char)*200, fp) != NULL && total
      Index<stateVecSize){
340                                 if (line[0]!='#'){
341                                         int chunkId = totalIndex/chunkSize;
342                                         if (chunkId==multiQubit->chunkId){
344                                                 sscanf(line, "%lf, %lf", &(stateV
      ecReal[indexInChunk]), 
345                                                                 &(stateVecImag[in
      dexInChunk]));
346                                                 indexInChunk += 1;
...
Definition at line 290 of file qubits.c.

References MultiQubit::chunkId, ComplexArray::imag, MultiQubit::numAmps, ComplexArray::real, REAL, and MultiQubit::stateVec.

Referenced by test\_\-controlNot(), test\_\-controlPhaseGate(), test\_\-controlRotateQubit(), test\_\-hadamard(), test\_\-quadCPhaseGate(), test\_\-rotateQubit(), test\_\-sGate(), test\_\-sigmaX(), test\_\-sigmaY(), test\_\-sigmaZ(), and test\_\-tGate().


\begin{DoxyCode}
291 {
292         long long int chunkSize;
293         long long int index;
294 
295         // dimension of the state vector
296         chunkSize = multiQubit->numAmps;
297 
298         // Can't use multiQubit->stateVec as a private OMP var
299         REAL *stateVecReal = multiQubit->stateVec.real;
300         REAL *stateVecImag = multiQubit->stateVec.imag;
301 
302         REAL chunkOffset = (2.0*chunkSize*multiQubit->chunkId)/10.0;
303 
304         // initialise the state to |0000..0000>
305 # ifdef _OPENMP
306 # pragma omp parallel \
307         default  (none) \
308         shared   (chunkSize, stateVecReal, stateVecImag, chunkOffset) \
309         private  (index) 
310 # endif
311         {
312 # ifdef _OPENMP
...
314 # endif
315                 for (index=0; index<chunkSize; index++) {
316                         stateVecReal[index] = chunkOffset + (index*2.0)/10.0;
317                         stateVecImag[index] = chunkOffset + (index*2.0+1.0)/10.0;
...
Definition at line 243 of file qubits.c.
...
Referenced by test\_\-findProbabilityOfOutcome(), and test\_\-measureInState().


\begin{DoxyCode}
244 {
245         long long int chunkSize, stateVecSize;
246         long long int index;
247         int bit;
248         const long long int chunkId=multiQubit->chunkId;
249 
250         // dimension of the state vector
251         chunkSize = multiQubit->numAmps;
252         stateVecSize = chunkSize*multiQubit->numChunks;
253         REAL normFactor = 1.0/sqrt(stateVecSize/2);
254 
255         // Can't use multiQubit->stateVec as a private OMP var
256         REAL *stateVecReal = multiQubit->stateVec.real;
257         REAL *stateVecImag = multiQubit->stateVec.imag;
258 
259         // initialise the state to |0000..0000>
260 # ifdef _OPENMP
261 # pragma omp parallel \
262         default  (none) \
263         shared   (chunkSize, stateVecReal, stateVecImag, normFactor, qubitId, out
      come) \
264         private  (index, bit) 
265 # endif
266         {
267 # ifdef _OPENMP
268                 # pragma omp for schedule (static)
269 # endif
270                 for (index=0; index<chunkSize; index++) {
271                         bit = extractBit(qubitId, index+chunkId*chunkSize);
272                         if (bit==outcome) {
273                                 stateVecReal[index] = normFactor;
274                                 stateVecImag[index] = 0.0;
275                         } else {
276                                 stateVecReal[index] = 0.0;
277                                 stateVecImag[index] = 0.0;
278                         }
279                 }
280         }
281         if (DEBUG) printf("COMPLETED INIT\n");
282 }
\end{DoxyCode}
...
Referenced by test\_\-filterOut111(), test\_\-findProbabilityOfOutcome(), test\_\-initStatePlus(), test\_\-measureInState(), and test\_\-probOfFilterOut111().
...
Referenced by test\_\-filterOut111(), test\_\-findProbabilityOfOutcome(), test\_\-initStateZero(), test\_\-measureInState(), and test\_\-probOfFilterOut111().
...
198 }
\end{DoxyCode}
\hypertarget{qubits_8c_a35e5ac30c8427c482a97b33a4e295535}{
\index{qubits.c@{qubits.c}!measureInStateDistributedRenorm@{measureInStateDistributedRenorm}}
\index{measureInStateDistributedRenorm@{measureInStateDistributedRenorm}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a35e5ac30c8427c482a97b33a4e295535}
...
1730 }
\end{DoxyCode}
\hypertarget{qubits_8c_ac39efc9ed939382276ebd0c15dd6a0fa}{
\index{qubits.c@{qubits.c}!measureInStateDistributedSetZero@{measureInStateDistributedSetZero}}
\index{measureInStateDistributedSetZero@{measureInStateDistributedSetZero}!qubits.c@{qubits.c}}
...
\label{qubits_8c_ac39efc9ed939382276ebd0c15dd6a0fa}
...
1779 }
\end{DoxyCode}
\hypertarget{qubits_8c_a53614ce19e0a4f2c41b400cf05dc5bd1}{
\index{qubits.c@{qubits.c}!measureInStateLocal@{measureInStateLocal}}
\index{measureInStateLocal@{measureInStateLocal}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a53614ce19e0a4f2c41b400cf05dc5bd1}
...
1221 }
\end{DoxyCode}
\hypertarget{qubits_8c_a096cddbac961f0651a084d2ceb905d1b}{
\index{qubits.c@{qubits.c}!probOfFilterOut111Local@{probOfFilterOut111Local}}
\index{probOfFilterOut111Local@{probOfFilterOut111Local}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a096cddbac961f0651a084d2ceb905d1b}
...
1879 }
\end{DoxyCode}
\hypertarget{qubits_8c_aca7765bd500718f98700a172351748cc}{
...
\label{qubits_8c_aca7765bd500718f98700a172351748cc}
...
Referenced by test\_\-quadCPhaseGate().
...
133 }
\end{DoxyCode}
\hypertarget{qubits_8c_a70b6649dc52a36ff2d0ed91fb443c3c4}{
\index{qubits.c@{qubits.c}!rotateQubitByAngle@{rotateQubitByAngle}}
\index{rotateQubitByAngle@{rotateQubitByAngle}!qubits.c@{qubits.c}}
...
\label{qubits_8c_a70b6649dc52a36ff2d0ed91fb443c3c4}
