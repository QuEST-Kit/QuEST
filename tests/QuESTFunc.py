...
rotateY = QuESTTestee          ("rotateY",          retType=None, argType=[Qureg,_targetQubit,qreal], defArg=[None,0,90.])
rotateZ = QuESTTestee          ("rotateZ",          retType=None, argType=[Qureg,_targetQubit,qreal], defArg=[None,0,90.])
...
controlledUnitary = QuESTTestee          ("controlledUnitary",          retType=None, argType=[Qureg,_controlQubit,_targetQubit,ComplexMatrix2], defArg=[None,1,0,unitMatrix]) 

# Multi-controlled Operations
multiControlledPhaseFlip = QuESTTestee  ("multiControlledPhaseFlip",  retType=None, argType=[Qureg,POINTER(c_int),c_int], defArg=[None,None,0])
multiControlledPhaseShift = QuESTTestee ("multiControlledPhaseShift", retType=None, argType=[Qureg,POINTER(c_int),c_int,qreal], defArg=[None,None,0,90.])
multiControlledUnitary = QuESTTestee    ("multiControlledUnitary",    retType=None, argType=[Qureg,POINTER(c_int),c_int,_targetQubit,ComplexMatrix2], defArg=[None,None,0,0,unitMatrix]) 

# Density Matrix Operations
addDensityMatrix = QuESTTestee             ("addDensityMatrix",             retType=None, argType=[Qureg,qreal,Qureg], defArg=[None,50.,None])
applyOneQubitDephaseError = QuESTTestee    ("applyOneQubitDephaseError",    retType=None, argType=[Qureg,_targetQubit,qreal], defArg=[None,0,100.])
applyOneQubitDepolariseError = QuESTTestee ("applyOneQubitDepolariseError", retType=None, argType=[Qureg,_targetQubit,qreal], defArg=[None,0,100.])
applyTwoQubitDephaseError = QuESTTestee    ("applyTwoQubitDephaseError",    retType=None, argType=[Qureg,_targetQubit,c_int,qreal], defArg=[None,0,1,100.])
applyTwoQubitDepolariseError = QuESTTestee ("applyTwoQubitDepolariseError", retType=None, argType=[Qureg,_targetQubit,c_int,qreal], defArg=[None,0,1,100.]) 
...
calcPurity = QuESTTestee        ("calcPurity",        retType=qreal, argType=[Qureg], defArg=[None])
collapseToOutcome = QuESTTestee ("collapseToOutcome", retType=None, argType=[Qureg,_targetQubit,c_int], defArg=[None,0,1]) 
getAmp = QuESTTestee            ("getAmp",            retType=Complex, argType=[Qureg,_stateIndex], defArg=[None,0])
getDensityAmp = QuESTTestee     ("getDensityAmp",     retType=Complex, argType=[Qureg,_stateIndex], defArg=[None,0])
getNumAmps = QuESTTestee        ("getNumAmps",        retType=c_int, argType=[Qureg], defArg=[None])
getImagAmp = QuESTTestee        ("getImagAmp",        retType=qreal, argType=[Qureg,_stateIndex], defArg=[None,0])
getProbAmp = QuESTTestee        ("getProbAmp",        retType=qreal, argType=[Qureg,_stateIndex], defArg=[None,0])
getRealAmp = QuESTTestee        ("getRealAmp",        retType=qreal, argType=[Qureg,_stateIndex], defArg=[None,0])
