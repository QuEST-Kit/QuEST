...
\begin{DoxyCode}
57 \{
58         \textcolor{keywordtype}{double} stateProb=0;
59         stateProb = \hyperlink{qubits_8c_a1c0a25823add0bd9f925a9164dc21870}{findProbabilityOfZeroLocal}(multiQubit, measureQubit);
60         \textcolor{keywordflow}{return} stateProb;
61 \}
\end{DoxyCode}
...
\begin{DoxyCode}
50 \{
51         \textcolor{comment}{// all values required to update state vector lie in this rank}
52         \hyperlink{qubits_8c_acb059cbcb8c7910a5fc43d21da4f5dea}{rotateQubitLocal}(multiQubit, rotQubit, alpha, beta);
53 \}
\end{DoxyCode}
