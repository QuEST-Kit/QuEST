...
TEST_COMP_FLAGS='-std=c++17 -Itests/catch/'
...
# MPI-specific flags
MPI_COMP_FLAGS='-I/opt/homebrew/opt/openmpi/include'
MPI_LINK_FLAGS='-L/opt/homebrew/opt/openmpi/lib -lmpi'
...
then
    ...
    # necessary on my EPFL Mac with brew-installed OpenMP
    OMP_COMP_FLAGS+=" -I/opt/homebrew/opt/libomp/include"
    OMP_LINK_FLAGS+=" -L/opt/homebrew/opt/libomp/lib"
else
